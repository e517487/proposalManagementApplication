...
export class CustomerMySuffixResolve implements Resolve<ICustomerMySuffix> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((customer: HttpResponse<CustomerMySuffix>) => customer.body);
        }
        return Observable.of(new CustomerMySuffix());
    }
}
...
export const customerRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'proposalManagementApplicationApp.customer.home.title'
        },

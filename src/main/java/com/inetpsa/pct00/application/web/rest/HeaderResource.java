...
public class HeaderResource {
    ...
    @GetMapping("/headers")
    @Timed
    public List<HeaderDTO> getAllHeaders(@RequestParam(required = false) String filter) {
        if ("aanvraagbericht-is-null".equals(filter)) {
            log.debug("REST request to get all Headers where aanvraagbericht is null");
            return headerService.findAllWhereAanvraagberichtIsNull();
        }

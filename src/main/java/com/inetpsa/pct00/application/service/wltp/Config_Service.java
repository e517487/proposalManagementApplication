 ...
 * 
 */
@WebServiceClient(name = "Config", targetNamespace = "http://xml.inetpsa.com/Services/Cfg/Config", wsdlLocation = "file:/C:/PSA-Projects/proposalManagementApplication/Config.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/PSA-Projects/proposalManagementApplication/Config.wsdl");

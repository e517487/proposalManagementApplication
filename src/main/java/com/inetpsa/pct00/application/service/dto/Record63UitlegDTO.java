...
/**
 * A DTO for the Record63Uitleg entity.
 */
public class Record63UitlegDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Record63UitlegDTO record63UitlegDTO = (Record63UitlegDTO) o;
        if (record63UitlegDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), record63UitlegDTO.getId());
    }
